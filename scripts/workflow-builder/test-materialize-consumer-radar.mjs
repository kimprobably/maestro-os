...
if (!promptfooConfig.includes("apps_fixture") || !promptfooConfig.includes("covered_signals") || !promptfooConfig.includes("defaultTest") || !promptfooConfig.includes("file://../apps/generated-consumer-app-radar/fixtures/apps.json") || !promptfooConfig.includes("evaluateOptions")) {
