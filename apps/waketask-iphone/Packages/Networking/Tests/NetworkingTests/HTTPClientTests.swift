...
final class HTTPClientTests: XCTestCase {
    ...
    func testGETSuccess() async throws {
        ...
        let expectedURL = try XCTUnwrap(URL(string: "https://api.example.com/v1/messages"))
    ...
    func testGETWithQueryParameters() async throws {
        ...
        let url1 = try XCTUnwrap(URL(string: "https://api.example.com/v1/search?q=swift&limit=10"))
        let url2 = try XCTUnwrap(URL(string: "https://api.example.com/v1/search?limit=10&q=swift"))
    ...
    func testHTTPServerError() async throws {
        // Given
        let path = "/v1/error"
        let expectedURL = try XCTUnwrap(URL(string: "https://api.example.com/v1/error"))
    ...
    func testHTTPClientError() async throws {
        ...
        let expectedURL = try XCTUnwrap(URL(string: "https://api.example.com/v1/notfound"))
    ...
    func testTransportErrorMapping() async throws {
        // Given
        let path = "/v1/offline"
        let expectedURL = try XCTUnwrap(URL(string: "https://api.example.com/v1/offline"))
    ...
    func testTimeoutErrorMapping() async throws {
        // Given
        let path = "/v1/timeout"
        let expectedURL = try XCTUnwrap(URL(string: "https://api.example.com/v1/timeout"))
    ...
    func testHeaderOverrideOrder() async throws {
        // Given
        let path = "/v1/custom"
        let expectedURL = try XCTUnwrap(URL(string: "https://api.example.com/v1/custom"))
