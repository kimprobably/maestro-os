...
public enum DSColors {
    ...
    nonisolated(unsafe) static var activeTheme: ThemePalette = .system(colorScheme: .light)
    ...
    public static var accentPrimary: Color {
        ...
        case .system, .light, .dark:
            named("AccentPrimary", fallback: Color(red: 0.0, green: 0.48, blue: 1.0))
        case .aurora:
            Color(red: 1.0, green: 0.45, blue: 0.6) // Vibrant coral/rose
        case .obsidian:
    ...
    public static var accentSecondary: Color {
        switch activeTheme {
        case .system, .light, .dark:
            named("AccentSecondary", fallback: Color(red: 0.4, green: 0.6, blue: 1.0))
        case .aurora:
            Color(red: 1.0, green: 0.6, blue: 0.4) // Warm peach/gold
        case .obsidian:
    ...
    public static var background: Color {
        ...
        case .aurora:
            Color(red: 0.99, green: 0.96, blue: 0.94) // Warm cream/ivory
        case .obsidian:
            Color(red: 0.08, green: 0.10, blue: 0.16) // Deep navy/indigo
        }
    }
    ...
    public static var surface: Color {
        ...
        case .aurora:
            Color(red: 1.0, green: 0.98, blue: 0.96) // Soft peachy white
        case .obsidian:
            Color(red: 0.12, green: 0.14, blue: 0.22) // Rich dark blue
        }
    }
    ...
    public static var surfaceElevated: Color {
        ...
        case .aurora:
            .white
        case .obsidian:
            Color(red: 0.16, green: 0.18, blue: 0.28) // Lighter navy for elevation
        }
    }
    ...
    public static var borderHairline: Color {
        ...
        case .system, .light, .dark:
            Color(.separator)
        case .aurora:
            Color(red: 1.0, green: 0.8, blue: 0.7).opacity(0.3) // Warm peachy border
        case .obsidian:
            Color(red: 0.4, green: 0.6, blue: 0.8).opacity(0.2) // Subtle blue glow
        }
    }
    ...
    public static var borderSubtle: Color {
        ...
        case .aurora:
            Color(red: 1.0, green: 0.75, blue: 0.65).opacity(0.4) // Warmer, more visible
        case .obsidian:
            Color(red: 0.5, green: 0.65, blue: 0.85).opacity(0.25) // Softer glow
        }
    }
    ...
    public static var textPrimary: Color {
        ...
        case .system, .light, .dark:
            Color(.label)
        case .aurora:
            Color(red: 0.2, green: 0.15, blue: 0.15) // Warm dark brown
        case .obsidian:
    ...
    public static var textSecondary: Color {
        ...
        case .aurora:
            Color(red: 0.55, green: 0.45, blue: 0.45) // Muted mauve
        case .obsidian:
            Color(red: 0.65, green: 0.7, blue: 0.8) // Soft blue-gray
        }
    }
    ...
    private static func named(_ name: String, fallback _: Color) -> Color {
    ...
    static func observeThemeChanges() {
        NotificationCenter.default.addObserver(
            ...
            guard let userInfo = notification.userInfo,
                  ...
                  let colorScheme = userInfo["colorScheme"] as? ColorScheme
            else {
                return
            }
