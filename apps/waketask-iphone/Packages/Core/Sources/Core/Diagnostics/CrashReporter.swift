...
public final class NoOpCrashReporter: CrashReporter {
    ...
    public func setUser(id _: String?, email _: String?, name _: String?) {}
    public func setAttributes(_: [String: String]) {}
    public func recordError(_: Error, context _: [String: String], isFatal _: Bool) {}
    public func log(message _: String, level _: LogLevel) {}
}
