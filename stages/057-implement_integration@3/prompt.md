...
- **verify_integration**: succeeded
  - Model: gpt-5.3-codex, 203.9k tokens in / 1.5k out
- **gate_integration**: failed
  ...
  - Output:
    ```
    {
      ...
      "failures": [
        ".workflow/iphone-app-factory/evidence/integration.md contains failing verdict"
      ]
    }
    ```
...
- failure_signature: gate_integration|deterministic|script failed with exit code: <n> ## output { "ok": false,"phase": "integration","appdir": "apps/waketask-iphone","failures": [ ".workflow/iphone-app-factory/evidence/integration.md contains failing verdict" ] }
