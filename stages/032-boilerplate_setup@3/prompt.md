...
- **architecture_consensus**: succeeded
  - Model: qwen/qwen3.6-plus, 193.3k tokens in / 8.2k out
  - Files: /home/daytona/workspace/.workflow/iphone-app-factory/adr.md, /home/daytona/workspace/.workflow/iphone-app-factory/architecture.md
...
- **boilerplate_setup**: succeeded
  - Model: gpt-5.3-codex, 307.2k tokens in / 2.9k out
- **boilerplate_gate**: failed
  ...
  - Output:
    ```
    {
      ...
      "failures": [
        "missing app_dir apps/waketask-iphone",
        "missing Config/App.xcconfig",
        "missing Packages directory",
        "missing .xcodeproj",
        "missing required boilerplate package Packages/Core",
        "missing required boilerplate package Packages/Networking",
        "missing required boilerplate package Packages/Storage",
        "missing required boilerplate package Packages/DesignSystem",
        "missing required boilerplate package Packages/Localization"
      ]
    }
    ```
- **boilerplate_setup**: succeeded
...
- failure_signature: boilerplate_gate|deterministic|script failed with exit code: <n> ## output { "ok": false,"appdir": "apps/waketask-iphone","failures": [ "missing app_dir apps/waketask-iphone","missing config/app.xcconfig","missing packages directory","missing .xcodeproj","missing require
- parallel.branch_count: 2
- parallel.fan_in.best_head_sha: 1c0dcbc0199401b20982ab3982e7e850008e4356
- parallel.fan_in.best_id: arch_claude
- parallel.fan_in.best_outcome: succeeded
- parallel.results: [{"id":"arch_codex","status":"succeeded","head_sha":"5f3c3a520ee5ed564fcb8bb61ef21b1ade887d98"},{"id":"arch_claude","status":"succeeded","head_sha":"1c0dcbc0199401b20982ab3982e7e850008e4356"}]
